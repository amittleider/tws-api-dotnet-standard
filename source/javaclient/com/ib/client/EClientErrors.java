...
public class EClientErrors {
    ...
    static final CodeMsgPair FAIL_SEND_REQMATCHINGSYMBOLS = new CodeMsgPair(559, "Request Matching Symbols Sending Error - ");
    static final CodeMsgPair FAIL_SEND_REQFAMILYCODES = new CodeMsgPair(560, "Request Family Codes Sending Error - ");
