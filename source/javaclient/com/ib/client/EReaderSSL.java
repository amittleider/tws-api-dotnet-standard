 ...
 */
public class EReaderSSL extends Thread {
    private EClientSocketSSL 	m_clientSocket;
    ...
    /**
     * Construct the EReaderSSL.
     * @param parent An EClientSocketSSL connected to TWS.
     * @param signal A callback that informs that there are messages in msg queue.
     */
    public EReaderSSL(EClientSocketSSL parent, EReaderSignal signal) {
